...
main_box = Label(final1, width=30, borderwidth=3, relief="sunken", anchor="w").place(x=40, y=20)
...
subtotal = Label(final1, width=18, borderwidth=2, relief="sunken", anchor="e")\
    .place(x=123, y=185)
tax = Label(final1, width=18, borderwidth=2, relief="sunken", anchor="e")\
    .place(x=123, y=225)
total = Label(final1, width=18, borderwidth=2, relief="sunken", anchor="e")\
    .place(x=123, y=265)
